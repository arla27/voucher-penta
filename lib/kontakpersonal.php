...
$i = 4;
$no = 1;
$res1 = mysqli_query($koneksi, "SELECT * FROM contacts WHERE type = 'Personal' and make_by = '$username' ");
...
header('Content-Disposition: attachment;filename="Kontak personal - ' . $username . '.xlsx"');
